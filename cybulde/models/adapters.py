...
class MLPLayer(Adapter):
    def __init__(
        self,
        output_feature_sizes: list[int], # [1024, 512, 256]
        ...
        assert nrof_layers == len(activation_functions) == len(dropout_drop_probabilities) == len(batch_normalizations) == len(biases)
