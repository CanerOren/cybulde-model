...
from cybulde.configs_schemas.evaluation.evaluation_task_schemas import DefaultCommonEvaluationTaskConfig
...
class LocalBertExperiment(Config):
    ...
    model_selector: Optional[model_selector_schemas.ModelSelectorConfig] = field(default_factory=model_selector_schemas.CyberBullyingDetectionModelSelectorConfig)
