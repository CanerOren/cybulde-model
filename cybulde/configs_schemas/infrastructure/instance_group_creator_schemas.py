...
from cybulde.configs_schemas.infrastructure.instance_template_creator_schemas import InstanceTemplateCreatorConfig

@dataclass
class InstanceGroupCreatorConfig:
    _target_: str = "cybulde.infrastructure.instance_group_creator.InstanceGroupCreator"
    instance_template_creator: InstanceTemplateCreatorConfig = field(default_factory=InstanceTemplateCreatorConfig)
