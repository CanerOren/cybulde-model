...
from cybulde.configs_schemas.evaluation import evaluation_lightning_module_schemas
...
class DefaultCommonEvaluationTaskConfig(CommonEvaluationTaskConfig):
    ...
    lightning_module: evaluation_lightning_module_schemas.PartialEvaluationLightningModuleConfig = field(default_factory= evaluation_lightning_module_schemas.BinaryTextEvaluationLightningModuleConfig)